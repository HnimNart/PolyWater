...
{
public:
  // Initializes the VulkanSlangCompiler.
  //
  ...
  explicit VulkanSlangCompiler(bool enableGLSL = false);
  ~VulkanSlangCompiler() = default;
...
public:
  ...
  VulkanSlangCompiler(VulkanSlangCompiler&&) = delete;
  VulkanSlangCompiler& operator=(VulkanSlangCompiler&&) = delete;
