#include "vulkan_slang_compiler.hpp"
...
/**********************************************************/
void detail::VulkanSlangCompiler::defaultTarget()
/**********************************************************/
{
  m_targets.push_back({
      .format = SLANG_SPIRV,
...
/**********************************************************/
void detail::VulkanSlangCompiler::defaultOptions()
/**********************************************************/
{
...
/**********************************************************/
void detail::VulkanSlangCompiler::addSearchPaths(
...
/**********************************************************/
void detail::VulkanSlangCompiler::clearSearchPaths()
/**********************************************************/
{
  m_searchPaths.clear();
...
/**********************************************************/
const uint32_t* detail::VulkanSlangCompiler::getSpirv() const
/**********************************************************/
{
  if (!m_spirv)
  {
...
/**********************************************************/
size_t detail::VulkanSlangCompiler::getSpirvSize() const
/**********************************************************/
{
  if (!m_spirv)
  {
...
/**********************************************************/
slang::IComponentType* detail::VulkanSlangCompiler::getSlangProgram() const
/**********************************************************/
{
  if (!m_linkedProgram)
  {
...
/**********************************************************/
slang::IModule* detail::VulkanSlangCompiler::getSlangModule() const
/**********************************************************/
{
  if (!m_module)
  {
...
/**********************************************************/
void detail::VulkanSlangCompiler::createSession()
/**********************************************************/
{
  m_session = {};
