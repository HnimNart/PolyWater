...
// It is used to store vertex data, index data, uniform data, and other types of
// data. There is a VkBuffer object that represents the buffer, and a
...
struct Image
{
  ...
  // descriptor.imageView may exist, created/destroyed by
...
//-----------------------------------------------------------------
// An acceleration structure is a region of memory used to store acceleration
...
// The family index is used to identify the queue family (graphic, compute,
