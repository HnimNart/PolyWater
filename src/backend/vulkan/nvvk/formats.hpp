...
// A helper function to find the depth format that is supported by the physical
// device.
VkFormat findDepthFormat(VkPhysicalDevice physicalDevice);

// A helper function to find the depth stencil format that is supported by the
// physical device.
