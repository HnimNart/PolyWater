...
#define FONT_ICON_FILE_NAME_MSO                                                \
  "MaterialSymbolsOutlined[FILL,GRAD,opsz,wght].ttf"
#define FONT_ICON_FILE_NAME_MSR                                                \
...
#define ICON_MS_SIGNAL_CELLULAR_CONNECTED_NO_INTERNET_0_BAR                    \
  "\xef\x82\xac"  // U+f0ac
#define ICON_MS_SIGNAL_CELLULAR_CONNECTED_NO_INTERNET_4_BAR                    \
  "\xee\x87\x8d"                                                    // U+e1cd
