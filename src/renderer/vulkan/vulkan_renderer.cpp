...
/**********************************************************/
{
  ...
  VulkanPipelineManager::BuildSettings settings{
      .context = m_context,
      .frameSyncManager = m_frameSyncManager,
      ...
      .colorFormats =
          {
              ...
              VK_FORMAT_R32G32B32A32_SFLOAT,  // [4] Albedo (OIDN)
              VK_FORMAT_R32G32B32A32_SFLOAT   // [5] Normal (OIDN)
          },
...
/**********************************************************/
{
  auto* pass = m_graph->findPass<VulkanToneMapPass>();
