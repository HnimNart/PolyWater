...
/**********************************************************/
RasterPass::RasterPass(VulkanContextManager *ctx,
                       const nvvk::DescriptorPack &descPack,
                       const VulkanSceneAssetManager *assetManager)
    : m_context_manager(ctx), m_descPack(descPack), m_assetManager(assetManager)
/**********************************************************/
{}
...
/**********************************************************/
{
  vkDestroyPipelineLayout(m_context_manager->getDevice(), m_pipelineLayout, nullptr);
  clearShaders();
}
