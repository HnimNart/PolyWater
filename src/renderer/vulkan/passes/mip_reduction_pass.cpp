#include "mip_reduction_pass.hpp"
...
/**********************************************************/
void MipReductionPass::createDescriptorLayout()
/**********************************************************/
{
  SCOPED_TIMER_FUNC();
...
/**********************************************************/
void MipReductionPass::createPipelineLayout()
/**********************************************************/
{
...
/**********************************************************/
void MipReductionPass::compileShaders()
/**********************************************************/
{
  SCOPED_TIMER_FUNC();
  auto computeCode = SlangCompiler::instance().compile("mip_reduction.slang",
                                                       mip_reduction_slang);
...
/**********************************************************/
void MipReductionPass::updateMipViews()
/**********************************************************/
{
...
/**********************************************************/
void MipReductionPass::dispatchReduction(VkCommandBuffer cmd,
                                         VkImageView inView,
...
/**********************************************************/
void MipReductionPass::transitionImage(VkCommandBuffer cmd, VkImage image,
