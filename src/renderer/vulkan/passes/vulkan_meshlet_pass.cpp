#include "vulkan_meshlet_pass.hpp"
...
/**********************************************************/
void VulkanMeshletPass::setup(PassBuilder& builder)
/**********************************************************/
{
...
/**********************************************************/
void VulkanMeshletPass::resize(VkCommandBuffer /*cmd*/, VkExtent2D /*size*/)
/**********************************************************/
{
}
...
/**********************************************************/
{
  ...
  if (culledCount > 0)
  {
    LOGD("VulkanMeshletPass: CPU Culled %u / %zu instances", culledCount,
...
/**********************************************************/
void VulkanMeshletPass::createPipelineLayout(VkDevice device)
/**********************************************************/
{
...
/**********************************************************/
void VulkanMeshletPass::clearShaders()
/**********************************************************/
{
...
/**********************************************************/
void VulkanMeshletPass::compileShaders()
/**********************************************************/
{
  SCOPED_TIMER_FUNC();
