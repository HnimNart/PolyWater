...
class core::ElementInspectorInternal
{
public:
  enum ValueType
  {
  ...
  struct ValueFormat
  {
    ...
    core::ElementInspector::ValueFormatFlag flags{core::ElementInspector::eVisible};
  };


  static inline void addVectorComponent(std::vector<core::ElementInspectorInternal::ValueFormat>& res,
                                        core::ElementInspector::ValueType                         minType,
                                        core::ElementInspector::ValueType                         type,
                                        const core::ElementInspectorInternal::ValueFormat&        src)

  {
    ...
    {
      core::ElementInspectorInternal::ValueFormat component = src;
      component.name += suffixes[i];
      res.emplace_back(component);
    }
  }

  static inline void addMatrixComponent(std::vector<core::ElementInspectorInternal::ValueFormat>& res,
                                        const core::ElementInspectorInternal::ValueFormat&        src,
...
#define MAT_TO_INTERNAL_CASE(type_, internalType_, dims_)                                                              \
  ...
  static std::vector<core::ElementInspectorInternal::ValueFormat> toInternalFormat(const std::vector<core::ElementInspector::ValueFormat>& format)
  {
    std::vector<core::ElementInspectorInternal::ValueFormat> res;

    for(auto& f : format)
    {
      core::ElementInspectorInternal::ValueFormat internal;
      internal.flags          = f.flags;
      internal.hexDisplay     = f.hexDisplay;
      internal.name           = f.name;
      uint32_t componentCount = 1;

      if(f.type <= core::ElementInspector::eFloat32)
      {
        componentCount = 1;
      ...
      VEC_TO_INTERNAL(core::ElementInspector::eU8Vec2, core::ElementInspector::eU8Vec4, eUint8);
      VEC_TO_INTERNAL(core::ElementInspector::eU16Vec2, core::ElementInspector::eU16Vec4, eUint16);
      VEC_TO_INTERNAL(core::ElementInspector::eU32Vec2, core::ElementInspector::eU32Vec4, eUint32);
      VEC_TO_INTERNAL(core::ElementInspector::eU64Vec2, core::ElementInspector::eU64Vec4, eUint64);

      VEC_TO_INTERNAL(core::ElementInspector::eS8Vec2, core::ElementInspector::eS8Vec4, eInt8);
      VEC_TO_INTERNAL(core::ElementInspector::eS16Vec2, core::ElementInspector::eS16Vec4, eInt16);
      VEC_TO_INTERNAL(core::ElementInspector::eS32Vec2, core::ElementInspector::eS32Vec4, eInt32);
      VEC_TO_INTERNAL(core::ElementInspector::eS64Vec2, core::ElementInspector::eS64Vec4, eInt64);

      VEC_TO_INTERNAL(core::ElementInspector::eF16Vec2, core::ElementInspector::eF16Vec4, eFloat16);
      VEC_TO_INTERNAL(core::ElementInspector::eF32Vec2, core::ElementInspector::eF32Vec4, eFloat32);

      switch(f.type)
      {
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat2x2, eUint8, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat2x3, eUint8, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat2x4, eUint8, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat2x2, eUint16, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat2x3, eUint16, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat2x4, eUint16, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat2x2, eUint32, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat2x3, eUint32, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat2x4, eUint32, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat2x2, eUint64, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat2x3, eUint64, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat2x4, eUint64, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat3x2, eUint8, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat3x3, eUint8, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat3x4, eUint8, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat3x2, eUint16, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat3x3, eUint16, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat3x4, eUint16, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat3x2, eUint32, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat3x3, eUint32, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat3x4, eUint32, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat3x2, eUint64, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat3x3, eUint64, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat3x4, eUint64, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat4x2, eUint8, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat4x3, eUint8, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU8Mat4x4, eUint8, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat4x2, eUint16, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat4x3, eUint16, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU16Mat4x4, eUint16, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat4x2, eUint32, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat4x3, eUint32, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU32Mat4x4, eUint32, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat4x2, eUint64, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat4x3, eUint64, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eU64Mat4x4, eUint64, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat2x2, eInt8, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat2x3, eInt8, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat2x4, eInt8, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat2x2, eInt16, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat2x3, eInt16, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat2x4, eInt16, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat2x2, eInt32, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat2x3, eInt32, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat2x4, eInt32, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat2x2, eInt64, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat2x3, eInt64, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat2x4, eInt64, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat3x2, eInt8, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat3x3, eInt8, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat3x4, eInt8, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat3x2, eInt16, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat3x3, eInt16, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat3x4, eInt16, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat3x2, eInt32, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat3x3, eInt32, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat3x4, eInt32, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat3x2, eInt64, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat3x3, eInt64, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat3x4, eInt64, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat4x2, eInt8, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat4x3, eInt8, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS8Mat4x4, eInt8, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat4x2, eInt16, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat4x3, eInt16, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS16Mat4x4, eInt16, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat4x2, eInt32, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat4x3, eInt32, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS32Mat4x4, eInt32, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat4x2, eInt64, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat4x3, eInt64, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eS64Mat4x4, eInt64, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat2x2, eFloat16, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat2x3, eFloat16, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat2x4, eFloat16, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat2x2, eFloat32, glm::uvec2(2, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat2x3, eFloat32, glm::uvec2(2, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat2x4, eFloat32, glm::uvec2(2, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat3x2, eFloat16, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat3x3, eFloat16, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat3x4, eFloat16, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat3x2, eFloat32, glm::uvec2(3, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat3x3, eFloat32, glm::uvec2(3, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat3x4, eFloat32, glm::uvec2(3, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat4x2, eFloat16, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat4x3, eFloat16, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF16Mat4x4, eFloat16, glm::uvec2(4, 4));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat4x2, eFloat32, glm::uvec2(4, 2));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat4x3, eFloat32, glm::uvec2(4, 3));
        MAT_TO_INTERNAL_CASE(core::ElementInspector::eF32Mat4x4, eFloat32, glm::uvec2(4, 4));
      }
    }
    return res;
  }
  ...
  void init(const core::ElementInspector::InitInfo& info);
  void deinit();

  void initImageInspection(uint32_t index, const core::ElementInspector::ImageInspectionInfo& info);
  void deinitImageInspection(uint32_t index, bool isCopy);
  bool updateImageFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat);
  void inspectImage(VkCommandBuffer cmd, uint32_t index, VkImageLayout currentLayout);

  void initBufferInspection(uint32_t index, const core::ElementInspector::BufferInspectionInfo& info);
  void deinitBufferInspection(uint32_t index);

  void inspectBuffer(VkCommandBuffer cmd, uint32_t index);
  bool updateBufferFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat);

  void initComputeInspection(uint32_t index, const core::ElementInspector::ComputeInspectionInfo& info);
  void deinitComputeInspection(uint32_t index);
  void inspectComputeVariables(VkCommandBuffer cmd, uint32_t index);
  bool updateComputeFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat);

  VkBuffer getComputeInspectionBuffer(uint32_t index);
  VkBuffer getComputeMetadataBuffer(uint32_t index);


  void initCustomInspection(uint32_t index, const core::ElementInspector::CustomInspectionInfo& info);
  void deinitCustomInspection(uint32_t index);
  void inspectCustomVariables(VkCommandBuffer cmd, uint32_t index);

  bool     updateCustomFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat);
  VkBuffer getCustomInspectionBuffer(uint32_t index);
  VkBuffer getCustomMetadataBuffer(uint32_t index);

  void initFragmentInspection(uint32_t index, const core::ElementInspector::FragmentInspectionInfo& info);
  ...
  bool     updateFragmentFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat);
  ...
  struct Filter
  {
    ...
    void create(const core::ElementInspectorInternal::InspectedBuffer& b);
    void destroy() {}
    bool imguiFilterColumns(const core::ElementInspectorInternal::InspectedBuffer& b);
  ...
  static inline uint32_t valueFormatSizeInBytes(const core::ElementInspectorInternal::ValueFormat& v)
  {
    switch(v.type)
    {
      case eUint8:
  ...
  static inline uint32_t computeFormatSizeInBytes(const std::vector<core::ElementInspectorInternal::ValueFormat>& format)
  {
  ...
  static inline bool imguiInputValue(const core::ElementInspectorInternal::ValueFormat& format, uint8_t* data)
  {
  ...
  struct InspectedBuffer
  {
    ...
    std::vector<core::ElementInspectorInternal::ValueFormat> format;
    std::string                                        name;
    std::string                                        comment;
    Filter                                             filter;
  ...
  void createInspectedBuffer(InspectedBuffer&                                          inspectedBuffer,
                             ...
                             const std::vector<core::ElementInspectorInternal::ValueFormat>& format,
                             uint32_t                                                  entryCount,
  ...
  std::string valueFormatToString(const core::ElementInspectorInternal::ValueFormat& v);

  std::string valueFormatTypeToString(const core::ElementInspectorInternal::ValueFormat& v);
  void bufferEntryToLdrPixel(const uint8_t* contents, const std::vector<core::ElementInspectorInternal::ValueFormat> format, uint8_t* dst);
  std::string bufferEntryToString(const uint8_t* contents, const std::vector<core::ElementInspectorInternal::ValueFormat> format);
  ...
  void saveCsvHeader(std::ofstream& out, const std::vector<core::ElementInspectorInternal::ValueFormat>& format);
...
static bool checkFormatFlag(const std::vector<core::ElementInspector::ValueFormat>& format)
{
  for(auto& f : format)
  {
    if(f.flags >= core::ElementInspector::eValueFormatFlagCount)
    {
...
template <typename T>
bool updateFormat(T& inspection, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  uint32_t originalSize = inspection.formatSizeInBytes;
  uint32_t newSize      = core::ElementInspectorInternal::computeFormatSizeInBytes(newFormat);
...
core::ElementInspector::ElementInspector()
    : m_internals(new core::ElementInspectorInternal)
{
}
...
void core::ElementInspector::onAttach(core::Application* app)
{
  m_internals->m_isAttached = true;
  m_internals->m_app        = app;
}

void core::ElementInspector::onDetach()
{
...
template <typename T>
void imguiCopy(core::Application* app, T& src, const std::vector<T>& existingOriginals, std::vector<T>& copies)
{
...
void core::ElementInspector::onUIRender()
{
  if(!m_internals->m_isAttached)
  {
    return;
...
void core::ElementInspectorInternal::imGuiComputeVariable(uint32_t i, bool isCopy)
{
...
void core::ElementInspectorInternal::imGuiImage(uint32_t imageIndex, ImVec2& imageSize, bool isCopy)
{
...
uint32_t core::ElementInspectorInternal::imGuiBufferContents(InspectedBuffer& buf,
                                                       uint32_t         begin,
                                                       uint32_t         end,
                                                       uint32_t         entrySizeInBytes,
                                                       glm::uvec3       extent,
                                                       ...
                                                       glm::uvec3       coordDisplayOffset) /*= {*/
{
  ...
  for(uint32_t i = begin; i < end; i++)
  {
    ...
    if(filteredOut == buf.entryCount)
    {
      ...
      {
        if((buf.format[i].flags & core::ElementInspector::eHidden) == 0)
        {
          if(buf.showSnapshot)
          {
            ImGui::TableNextColumn();
...
void core::ElementInspectorInternal::imGuiBuffer(InspectedBuffer& buf,
                                           uint32_t         topItem /*= ~0u*/,
                                           glm::uvec3       extent,
                                           bool             defaultOpen /*= false*/,
                                           ...
                                           bool             showCollapsibleHeader /*= true*/)
{
     ...
     && (!showCollapsibleHeader || ImGui::CollapsingHeader(buf.name.c_str(), defaultOpen ? ImGuiTreeNodeFlags_DefaultOpen : 0)))
  {
    ...
    {
      if(f.flags == core::ElementInspector::eVisible)
      {
    ...
    for(size_t i = 0; i < buf.format.size(); i++)
    {
      ...
      if(buf.format[i].flags != VALUE_FLAG_INTERNAL && buf.format[i].flags == core::ElementInspector::eVisible)
      {
...
void core::ElementInspectorInternal::saveBufferSnapshotToFile(InspectedBuffer& buf)
{
  if(!buf.saveSnapshotToFileRequested)
  {
    return;
...
void core::ElementInspectorInternal::saveImageSnapshotToFile(InspectedImage& img)
{
  if(img.snapshotRequested)
  {
    uint32_t entrySizeInBytes = img.formatSizeInBytes;
...
void core::ElementInspectorInternal::saveCsvHeader(std::ofstream& out, const std::vector<core::ElementInspectorInternal::ValueFormat>& format)
{
  for(size_t i = 0; i < format.size(); i++)
  {
    if(format[i].flags == core::ElementInspector::eVisible)
    {
...
void core::ElementInspectorInternal::saveCsvEntry(std::ofstream& out, const InspectedBuffer& buf, size_t index)
{
...
glm::uvec3 core::ElementInspectorInternal::getThreadInvocationId(uint32_t                   absoluteBlockIndex,
                                                           uint32_t                   warpIndex,
...
std::string core::ElementInspectorInternal::multiDimUvec3ToString(const glm::uvec3 v, bool forceMultiDim /*= false*/)
{
...
void core::ElementInspectorInternal::createInspectedBuffer(InspectedBuffer&   inspectedBuffer,
                                                     VkBuffer           sourceBuffer,
                                                     const std::string& name,
                                                     const std::vector<core::ElementInspectorInternal::ValueFormat>& format,
                                                     uint32_t           entryCount,
...
void core::ElementInspectorInternal::destroyInspectedBuffer(InspectedBuffer& inspectedBuffer)
{
...
void core::ElementInspectorInternal::imGuiGrid(uint32_t index, InspectedComputeVariables& computeVar)
{
...
void core::ElementInspectorInternal::imGuiBlock(uint32_t absoluteBlockIndex, InspectedComputeVariables& computeVar, uint32_t offsetInBytes)
{
...
static inline void imguiBufferCell(const uint8_t*                               content,
                                   const core::ElementInspectorInternal::ValueFormat& format,
                                   ...
                                   ImU32&                                       outBackgroundColor)
{
  ...
  if(format.hexDisplay)
  {
    sss << "0x" << std::uppercase << std::setfill('0')
        << std::setw(core::ElementInspectorInternal::valueFormatSizeInBytes(format) * 2) << std::hex;
  }
  else
  {
    sss << std::fixed << std::setprecision(5);
  }
  if(format.flags == core::ElementInspector::eVisible)
  {
    ImGui::TableNextColumn();
  }
  outBackgroundColor = {};
  switch(format.type)
  {
    ...
    case core::ElementInspectorInternal::eFloat32:
      ...
      break;
    case core::ElementInspectorInternal::eInt64:
      outBackgroundColor = colorFromValue(*(const int64_t*)content);
      sss << *(const int64_t*)content;
      break;
    case core::ElementInspectorInternal::eUint64:
      outBackgroundColor = colorFromValue(*(const uint32_t*)content);
...
void core::ElementInspectorInternal::imGuiColumns(const InspectedBuffer& buffer, uint32_t offsetInBytes)
{
  ...
  for(size_t i = 0; i < format.size(); i++)
  {
    if(format[i].flags != VALUE_FLAG_INTERNAL && format[i].flags == core::ElementInspector::eVisible)
    {
...
void core::ElementInspectorInternal::imGuiWarp(uint32_t                   absoluteBlockIndex,
...
void core::ElementInspector::onUIMenu()
{
...
core::ElementInspector::ValueType core::ElementInspector::glslStringToType(const std::string& typeString)
{
  if(typeString == "uint8_t")
    return core::ElementInspector::eUint8;
  if(typeString == "uint16_t")
    return core::ElementInspector::eUint16;
  if(typeString == "uint32_t")
    return core::ElementInspector::eUint32;
  if(typeString == "uint64_t")
    return core::ElementInspector::eUint64;
  if(typeString == "int8_t")
    return core::ElementInspector::eInt8;
  if(typeString == "int16_t")
    return core::ElementInspector::eInt16;
  if(typeString == "int32_t")
    return core::ElementInspector::eInt32;
  if(typeString == "int64_t")
    return core::ElementInspector::eInt64;
  //if (typeString == "half") return core::ElementInspector::eFloat16;
  if(typeString == "float")
    return core::ElementInspector::eFloat32;
  if(typeString == "u8vec2")
    return core::ElementInspector::eU8Vec2;
  if(typeString == "u8vec3")
    return core::ElementInspector::eU8Vec3;
  if(typeString == "u8vec4")
    return core::ElementInspector::eU8Vec4;
  if(typeString == "u16vec2")
    return core::ElementInspector::eU16Vec2;
  if(typeString == "u16vec3")
    return core::ElementInspector::eU16Vec3;
  if(typeString == "u16vec4")
    return core::ElementInspector::eU16Vec4;
  if(typeString == "uvec2")
    return core::ElementInspector::eU32Vec2;
  if(typeString == "uvec3")
    return core::ElementInspector::eU32Vec3;
  if(typeString == "uvec4")
    return core::ElementInspector::eU32Vec4;
  if(typeString == "u64vec2")
    return core::ElementInspector::eU64Vec2;
  if(typeString == "u64vec3")
    return core::ElementInspector::eU64Vec3;
  if(typeString == "u64vec4")
    return core::ElementInspector::eU64Vec4;
  if(typeString == "i8vec2")
    return core::ElementInspector::eS8Vec2;
  if(typeString == "i8vec3")
    return core::ElementInspector::eS8Vec3;
  if(typeString == "i8vec4")
    return core::ElementInspector::eS8Vec4;
  if(typeString == "i16vec2")
    return core::ElementInspector::eS16Vec2;
  if(typeString == "i16vec3")
    return core::ElementInspector::eS16Vec3;
  if(typeString == "i16vec4")
    return core::ElementInspector::eS16Vec4;
  if(typeString == "ivec2")
    return core::ElementInspector::eS32Vec2;
  if(typeString == "ivec3")
    return core::ElementInspector::eS32Vec3;
  if(typeString == "ivec4")
    return core::ElementInspector::eS32Vec4;
  if(typeString == "i64vec2")
    return core::ElementInspector::eS64Vec2;
  if(typeString == "i64vec3")
    return core::ElementInspector::eS64Vec3;
  if(typeString == "i64vec4")
    return core::ElementInspector::eS64Vec4;
  //if (typeString == "") return core::ElementInspector::eF16Vec2;
  //if (typeString == "") return core::ElementInspector::eF16Vec3;
  //if (typeString == "") return core::ElementInspector::eF16Vec4;
  if(typeString == "vec2")
    return core::ElementInspector::eF32Vec2;
  if(typeString == "vec3")
    return core::ElementInspector::eF32Vec3;
  if(typeString == "vec4")
    return core::ElementInspector::eF32Vec4;
  if(typeString == "u8mat2")
    return core::ElementInspector::eU8Mat2x2;
  if(typeString == "u8mat2x3")
    return core::ElementInspector::eU8Mat2x3;
  if(typeString == "u8mat2x4")
    return core::ElementInspector::eU8Mat2x4;
  if(typeString == "u16mat2")
    return core::ElementInspector::eU16Mat2x2;
  if(typeString == "u16mat2x3")
    return core::ElementInspector::eU16Mat2x3;
  if(typeString == "u16mat2x4")
    return core::ElementInspector::eU16Mat2x4;
  if(typeString == "umat2")
    return core::ElementInspector::eU32Mat2x2;
  if(typeString == "umat2x3")
    return core::ElementInspector::eU32Mat2x3;
  if(typeString == "umat2x4")
    return core::ElementInspector::eU32Mat2x4;
  if(typeString == "u64mat2")
    return core::ElementInspector::eU64Mat2x2;
  if(typeString == "u64mat2x3")
    return core::ElementInspector::eU64Mat2x3;
  if(typeString == "u64mat2x4")
    return core::ElementInspector::eU64Mat2x4;
  if(typeString == "u8mat3x2")
    return core::ElementInspector::eU8Mat3x2;
  if(typeString == "u8mat3")
    return core::ElementInspector::eU8Mat3x3;
  if(typeString == "u8mat3x4")
    return core::ElementInspector::eU8Mat3x4;
  if(typeString == "u16mat3x2")
    return core::ElementInspector::eU16Mat3x2;
  if(typeString == "u16mat3")
    return core::ElementInspector::eU16Mat3x3;
  if(typeString == "u16mat3x4")
    return core::ElementInspector::eU16Mat3x4;
  if(typeString == "u32mat3x2")
    return core::ElementInspector::eU32Mat3x2;
  if(typeString == "u32mat3")
    return core::ElementInspector::eU32Mat3x3;
  if(typeString == "u32mat3x4")
    return core::ElementInspector::eU32Mat3x4;
  if(typeString == "u64mat3x2")
    return core::ElementInspector::eU64Mat3x2;
  if(typeString == "u64mat3")
    return core::ElementInspector::eU64Mat3x3;
  if(typeString == "u64mat3x4")
    return core::ElementInspector::eU64Mat3x4;
  if(typeString == "u8mat4x2")
    return core::ElementInspector::eU8Mat4x2;
  if(typeString == "u8mat4x3")
    return core::ElementInspector::eU8Mat4x3;
  if(typeString == "u8mat4")
    return core::ElementInspector::eU8Mat4x4;
  if(typeString == "u16mat4x2")
    return core::ElementInspector::eU16Mat4x2;
  if(typeString == "u16mat4x3")
    return core::ElementInspector::eU16Mat4x3;
  if(typeString == "u16mat4")
    return core::ElementInspector::eU16Mat4x4;
  if(typeString == "u32mat4x2")
    return core::ElementInspector::eU32Mat4x2;
  if(typeString == "u32mat4x3")
    return core::ElementInspector::eU32Mat4x3;
  if(typeString == "u32mat4")
    return core::ElementInspector::eU32Mat4x4;
  if(typeString == "u64mat4x2")
    return core::ElementInspector::eU64Mat4x2;
  if(typeString == "u64mat4x3")
    return core::ElementInspector::eU64Mat4x3;
  if(typeString == "u64mat4")
    return core::ElementInspector::eU64Mat4x4;
  if(typeString == "i8mat2")
    return core::ElementInspector::eS8Mat2x2;
  if(typeString == "i8mat2x3")
    return core::ElementInspector::eS8Mat2x3;
  if(typeString == "i8mat2x4")
    return core::ElementInspector::eS8Mat2x4;
  if(typeString == "i16mat2")
    return core::ElementInspector::eS16Mat2x2;
  if(typeString == "i16mat2x3")
    return core::ElementInspector::eS16Mat2x3;
  if(typeString == "i16mat2x4")
    return core::ElementInspector::eS16Mat2x4;
  if(typeString == "i32mat2")
    return core::ElementInspector::eS32Mat2x2;
  if(typeString == "i32mat2x3")
    return core::ElementInspector::eS32Mat2x3;
  if(typeString == "i32mat2x4")
    return core::ElementInspector::eS32Mat2x4;
  if(typeString == "i64mat2")
    return core::ElementInspector::eS64Mat2x2;
  if(typeString == "i64mat2x3")
    return core::ElementInspector::eS64Mat2x3;
  if(typeString == "i64mat2x4")
    return core::ElementInspector::eS64Mat2x4;
  if(typeString == "i8mat3x2")
    return core::ElementInspector::eS8Mat3x2;
  if(typeString == "i8mat3")
    return core::ElementInspector::eS8Mat3x3;
  if(typeString == "i8mat3x4")
    return core::ElementInspector::eS8Mat3x4;
  if(typeString == "i16mat3x2")
    return core::ElementInspector::eS16Mat3x2;
  if(typeString == "i16mat3")
    return core::ElementInspector::eS16Mat3x3;
  if(typeString == "i16mat3x4")
    return core::ElementInspector::eS16Mat3x4;
  if(typeString == "i32mat3x2")
    return core::ElementInspector::eS32Mat3x2;
  if(typeString == "i32mat3")
    return core::ElementInspector::eS32Mat3x3;
  if(typeString == "i32mat3x4")
    return core::ElementInspector::eS32Mat3x4;
  if(typeString == "i64mat3x2")
    return core::ElementInspector::eS64Mat3x2;
  if(typeString == "i64mat3")
    return core::ElementInspector::eS64Mat3x3;
  if(typeString == "i64mat3x4")
    return core::ElementInspector::eS64Mat3x4;
  if(typeString == "i8mat4x2")
    return core::ElementInspector::eS8Mat4x2;
  if(typeString == "i8mat4x3")
    return core::ElementInspector::eS8Mat4x3;
  if(typeString == "i8mat4")
    return core::ElementInspector::eS8Mat4x4;
  if(typeString == "i16mat4x2")
    return core::ElementInspector::eS16Mat4x2;
  if(typeString == "i16mat4x3")
    return core::ElementInspector::eS16Mat4x3;
  if(typeString == "i16mat4")
    return core::ElementInspector::eS16Mat4x4;
  if(typeString == "i32mat4x2")
    return core::ElementInspector::eS32Mat4x2;
  if(typeString == "i32mat4x3")
    return core::ElementInspector::eS32Mat4x3;
  if(typeString == "i32mat4")
    return core::ElementInspector::eS32Mat4x4;
  if(typeString == "i64mat4x2")
    return core::ElementInspector::eS64Mat4x2;
  if(typeString == "i64mat4x3")
    return core::ElementInspector::eS64Mat4x3;
  if(typeString == "i64mat4")
    return core::ElementInspector::eS64Mat4x4;
  //if (typeString == "") return core::ElementInspector::eF16Mat2x2;
  //if (typeString == "") return core::ElementInspector::eF16Mat2x3;
  //if (typeString == "") return core::ElementInspector::eF16Mat2x4;
  if(typeString == "mat2")
    return core::ElementInspector::eF32Mat2x2;
  if(typeString == "mat2x3")
    return core::ElementInspector::eF32Mat2x3;
  if(typeString == "mat2x4")
    return core::ElementInspector::eF32Mat2x4;
  //if (typeString == "") return core::ElementInspector::eF16Mat3x2;
  //if (typeString == "") return core::ElementInspector::eF16Mat3x3;
  //if (typeString == "") return core::ElementInspector::eF16Mat3x4;
  if(typeString == "mat3x2")
    return core::ElementInspector::eF32Mat3x2;
  if(typeString == "mat3")
    return core::ElementInspector::eF32Mat3x3;
  if(typeString == "mat3x4")
    return core::ElementInspector::eF32Mat3x4;
  //if (typeString == "") return core::ElementInspector::eF16Mat4x2;
  //if (typeString == "") return core::ElementInspector::eF16Mat4x3;
  //if (typeString == "") return core::ElementInspector::eF16Mat4x4;
  if(typeString == "mat4x2")
    return core::ElementInspector::eF32Mat4x2;
  if(typeString == "mat4x3")
    return core::ElementInspector::eF32Mat4x3;
  if(typeString == "mat4")
    return core::ElementInspector::eF32Mat4x4;
  LOGE("glslStringToType: unknown type string \"%s\"\n", typeString.c_str());
  return core::ElementInspector::eUint32;
}


std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatStruct(const std::string& structure)
{
  std::vector<core::ElementInspector::ValueFormat> res;
  size_t                                     pos{};
  ...
  while(true)
  {
    ...
    core::ElementInspector::ValueFormat value{};
...
void core::ElementInspector::init(const InitInfo& info)
{
  m_internals->init(info);
}

void core::ElementInspectorInternal::init(const core::ElementInspector::InitInfo& info)
{
  m_alloc = info.allocator;
  if(m_alloc == nullptr)
  {
    LOGE("core::ElementInspector: allocator cannot be nullptr\n");
    assert(false);
    return;
  }
  if(info.device == VK_NULL_HANDLE)
  {
    LOGE("core::ElementInspector: device cannot be VK_NULL_HANDLE\n");
    assert(false);
    return;
  }
  if(info.queueInfo.familyIndex == ~0u)
  {
    LOGE("core::ElementInspector: queue info cannot be ~0u\n");
    assert(false);
    return;
  }
...
void core::ElementInspector::deinit()
{
  m_internals->deinit();
}


void core::ElementInspectorInternal::deinit()
{
...
void core::ElementInspector::initImageInspection(uint32_t index, const ImageInspectionInfo& info)
{
  m_internals->initImageInspection(index, info);
}

void core::ElementInspectorInternal::initImageInspection(uint32_t index, const core::ElementInspector::ImageInspectionInfo& info)
{
  if(!checkInitialized())
  {
    return;
  ...
  core::ElementInspectorInternal::InspectedImage& inspectedImage = m_inspectedImages[index];
...
void core::ElementInspector::deinitImageInspection(uint32_t index)
{
  m_internals->deinitImageInspection(index, false);
}


void core::ElementInspectorInternal::deinitImageInspection(uint32_t index, bool isCopy)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::initBufferInspection(uint32_t index, const BufferInspectionInfo& info)
{
...
void core::ElementInspectorInternal::initBufferInspection(uint32_t index, const core::ElementInspector::BufferInspectionInfo& info)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::deinitBufferInspection(uint32_t index)
{
  m_internals->deinitBufferInspection(index);
}

void core::ElementInspectorInternal::deinitBufferInspection(uint32_t index)
{
  if(!checkInitialized())
  {
    return;
...
bool core::ElementInspector::updateImageFormat(uint32_t index, const std::vector<core::ElementInspector::ValueFormat>& newFormat)
{
  return m_internals->updateImageFormat(index, core::ElementInspectorInternal::toInternalFormat(newFormat));
}

bool core::ElementInspectorInternal::updateImageFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  if(!m_isInitialized)
  {
    return false;
...
void core::ElementInspector::inspectImage(VkCommandBuffer cmd, uint32_t index, VkImageLayout currentLayout)
{
  m_internals->inspectImage(cmd, index, currentLayout);
}

void core::ElementInspectorInternal::inspectImage(VkCommandBuffer cmd, uint32_t index, VkImageLayout currentLayout)
{
...
std::string core::ElementInspectorInternal::valueFormatToString(const core::ElementInspectorInternal::ValueFormat& v)
{
  return v.name;
}


std::string core::ElementInspectorInternal::valueFormatTypeToString(const core::ElementInspectorInternal::ValueFormat& v)
{
...
void core::ElementInspectorInternal::bufferEntryToLdrPixel(const uint8_t*                                           contents,
                                                     const std::vector<core::ElementInspectorInternal::ValueFormat> format,
                                                     uint8_t* destination)
{
...
std::string core::ElementInspectorInternal::bufferEntryToString(const uint8_t* contents,
                                                          const std::vector<core::ElementInspectorInternal::ValueFormat> format)
{
  const uint8_t*    current = contents;
  std::stringstream sss;
  for(size_t i = 0; i < format.size(); i++)
  {
    ...
    if(format[i].flags == core::ElementInspector::eHidden)
    {
      continue;
    }
...
void core::ElementInspector::inspectBuffer(VkCommandBuffer cmd, uint32_t index)
{
  m_internals->inspectBuffer(cmd, index);
}

void core::ElementInspectorInternal::inspectBuffer(VkCommandBuffer cmd, uint32_t index)
{
  if(!m_isAttached || !m_isInitialized)
  {
    return;
...
bool core::ElementInspector::updateBufferFormat(uint32_t index, const std::vector<ValueFormat>& newFormat)
{
  return m_internals->updateBufferFormat(index, core::ElementInspectorInternal::toInternalFormat(newFormat));
}

bool core::ElementInspectorInternal::updateBufferFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  if(!m_isInitialized)
  {
    return false;
...
void core::ElementInspector::appendStructToFormat(std::vector<ValueFormat>&       format,
                                            ...
                                            bool                            forceHidden /*= false*/)
{
  ...
  for(size_t i = originalSize; i < format.size(); i++)
  {
    ...
    if(forceHidden)
    {
      format[i].flags = core::ElementInspector::eHidden;
    }
  }
}


void core::ElementInspector::initComputeInspection(uint32_t index, const ComputeInspectionInfo& info)
{
  m_internals->initComputeInspection(index, info);
}

void core::ElementInspectorInternal::initComputeInspection(uint32_t index, const core::ElementInspector::ComputeInspectionInfo& info)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::deinitComputeInspection(uint32_t index)
{
  m_internals->deinitComputeInspection(index);
}

void core::ElementInspectorInternal::deinitComputeInspection(uint32_t index)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::inspectComputeVariables(VkCommandBuffer cmd, uint32_t index)
{
  m_internals->inspectComputeVariables(cmd, index);
}

void core::ElementInspectorInternal::inspectComputeVariables(VkCommandBuffer cmd, uint32_t index)
{
  if(!m_isAttached || !m_isInitialized)
  {
    return;
...
bool core::ElementInspector::updateComputeFormat(uint32_t index, const std::vector<ValueFormat>& newFormat)
{
  return m_internals->updateComputeFormat(index, core::ElementInspectorInternal::toInternalFormat(newFormat));
}


bool core::ElementInspectorInternal::updateComputeFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  if(!m_isInitialized)
  {
    return false;
...
VkBuffer core::ElementInspector::getComputeInspectionBuffer(uint32_t index)
{
  return m_internals->getComputeInspectionBuffer(index);
}

VkBuffer core::ElementInspectorInternal::getComputeInspectionBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
...
VkBuffer core::ElementInspector::getComputeMetadataBuffer(uint32_t index)
{
  return m_internals->getComputeMetadataBuffer(index);
}

VkBuffer core::ElementInspectorInternal::getComputeMetadataBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
    return VK_NULL_HANDLE;
...
void core::ElementInspector::initCustomInspection(uint32_t index, const CustomInspectionInfo& info)
{
  m_internals->initCustomInspection(index, info);
}

void core::ElementInspectorInternal::initCustomInspection(uint32_t index, const core::ElementInspector::CustomInspectionInfo& info)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::deinitCustomInspection(uint32_t index)
{
  m_internals->deinitCustomInspection(index);
}

void core::ElementInspectorInternal::deinitCustomInspection(uint32_t index)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::inspectCustomVariables(VkCommandBuffer cmd, uint32_t index)
{
  m_internals->inspectCustomVariables(cmd, index);
}

void core::ElementInspectorInternal::inspectCustomVariables(VkCommandBuffer cmd, uint32_t index)
{
  if(!m_isAttached || !m_isInitialized)
  {
    return;
...
bool core::ElementInspector::updateCustomFormat(uint32_t index, const std::vector<ValueFormat>& newFormat)
{
  return m_internals->updateCustomFormat(index, core::ElementInspectorInternal::toInternalFormat(newFormat));
}

bool core::ElementInspectorInternal::updateCustomFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  if(!m_isInitialized)
  {
    return false;
...
VkBuffer core::ElementInspector::getCustomInspectionBuffer(uint32_t index)
{
  return m_internals->getCustomInspectionBuffer(index);
}


VkBuffer core::ElementInspectorInternal::getCustomInspectionBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
    return VK_NULL_HANDLE;
...
VkBuffer core::ElementInspector::getCustomMetadataBuffer(uint32_t index)
{
  return m_internals->getCustomMetadataBuffer(index);
}

VkBuffer core::ElementInspectorInternal::getCustomMetadataBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
    return VK_NULL_HANDLE;
...
void core::ElementInspector::initFragmentInspection(uint32_t index, const FragmentInspectionInfo& info)
{
  m_internals->initFragmentInspection(index, info);
}

void core::ElementInspectorInternal::initFragmentInspection(uint32_t index, const core::ElementInspector::FragmentInspectionInfo& info)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::deinitFragmentInspection(uint32_t index)
{
  m_internals->deinitFragmentInspection(index);
}

void core::ElementInspectorInternal::deinitFragmentInspection(uint32_t index)
{
  if(!checkInitialized())
  {
    return;
...
void core::ElementInspector::clearFragmentVariables(VkCommandBuffer cmd, uint32_t index)
{
  m_internals->clearFragmentVariables(cmd, index);
}

void core::ElementInspectorInternal::clearFragmentVariables(VkCommandBuffer cmd, uint32_t index)
{
  if(!m_isAttached || !m_isInitialized)
  {
    return;
...
void core::ElementInspector::inspectFragmentVariables(VkCommandBuffer cmd, uint32_t index)
{
  m_internals->inspectFragmentVariables(cmd, index);
}

void core::ElementInspectorInternal::inspectFragmentVariables(VkCommandBuffer cmd, uint32_t index)
{
  if(!m_isAttached || !m_isInitialized)
  {
    return;
...
void core::ElementInspector::updateMinMaxFragmentInspection(VkCommandBuffer cmd, uint32_t index, const glm::uvec2& minFragment, const glm::uvec2& maxFragment)
{
  m_internals->updateMinMaxFragmentInspection(cmd, index, minFragment, maxFragment);
}

void core::ElementInspectorInternal::updateMinMaxFragmentInspection(VkCommandBuffer   cmd,
                                                              uint32_t          index,
...
bool core::ElementInspector::updateFragmentFormat(uint32_t index, const std::vector<ValueFormat>& newFormat)
{
  return m_internals->updateFragmentFormat(index, core::ElementInspectorInternal::toInternalFormat(newFormat));
}

bool core::ElementInspectorInternal::updateFragmentFormat(uint32_t index, const std::vector<core::ElementInspectorInternal::ValueFormat>& newFormat)
{
  if(!m_isInitialized)
  {
    return false;
...
VkBuffer core::ElementInspector::getFragmentInspectionBuffer(uint32_t index)
{
  return m_internals->getFragmentInspectionBuffer(index);
}

VkBuffer core::ElementInspectorInternal::getFragmentInspectionBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
    return VK_NULL_HANDLE;
...
VkBuffer core::ElementInspector::getFragmentMetadataBuffer(uint32_t index)
{
  return m_internals->getFragmentMetadataBuffer(index);
}

VkBuffer core::ElementInspectorInternal::getFragmentMetadataBuffer(uint32_t index)
{
  if(!m_isInitialized)
  {
    return VK_NULL_HANDLE;
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatRGBA8(const std::string& name /*= ""*/)
{
  if(name.empty())
  {
    return {
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatRGBA32(const std::string& name /*= ""*/)
{
  if(name.empty())
  {
    return {
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatVector4(ValueType type, const std::string& name)
{
  if(name == "")
  {
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatVector3(ValueType type, const std::string& name)
{
  if(name == "")
  {
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatVector2(ValueType type, const std::string& name)
{
  if(name == "")
  {
...
std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatValue(ValueType type, const std::string& name)
{
  return {{type, name}};
}

std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatInt32(const std::string& name /*= "value"*/)
{
  return formatValue(eInt32, name);
}

std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatUint32(const std::string& name /*= "value"*/)
{
  return formatValue(eUint32, name);
}

std::vector<core::ElementInspector::ValueFormat> core::ElementInspector::formatFloat32(const std::string& name /*= "value"*/)
{
  return formatValue(eFloat32, name);
}

void core::ElementInspectorInternal::Filter::create(const core::ElementInspectorInternal::InspectedBuffer& b)
{
...
void sanitizeFilterBounds(const std::vector<core::ElementInspectorInternal::ValueFormat>& format, uint8_t* filterMin, uint8_t* filterMax)
{
  ...
  for(size_t i = 0; i < format.size(); i++)
  {
    ...
    uint32_t sizeInBytes = core::ElementInspectorInternal::valueFormatSizeInBytes(format[i]);
...
bool core::ElementInspectorInternal::Filter::imguiFilterColumns(const core::ElementInspectorInternal::InspectedBuffer& b)
{
  ...
  for(size_t i = 0; i < format.size(); i++)
  {
    if(format[i].flags == core::ElementInspector::eHidden || format[i].flags == VALUE_FLAG_INTERNAL)
    {
...
bool core::ElementInspectorInternal::Filter::filterPasses(const InspectedBuffer& buffer, uint32_t offset)
{
